...
struct FollowPersonGoal_
{
  ...
  (void)_alloc;
   ...
   typedef uint64_t _person_id_type;
...
struct MD5Sum< ::rococo_navigation::FollowPersonGoal_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xbc669fb86b77765bULL;
  static const uint64_t static_value2 = 0x83a3fdd1f702ad5eULL;
};
...
struct Printer< ::rococo_navigation::FollowPersonGoal_<ContainerAllocator> >
{
  ...
  {
    s << indent << "person_id: ";
    Printer<uint64_t>::stream(s, indent + "  ", v.person_id);
    s << indent << "max_vel: ";
