...
let FollowPersonGoal = require('./FollowPersonGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FollowPersonActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new FollowPersonGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FollowPersonGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static md5sum() {
    ...
    return '0dddb57681502653d87424591381c454';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowPersonActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FollowPersonGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FollowPersonGoal()
    }
...
module.exports = FollowPersonActionGoal;
