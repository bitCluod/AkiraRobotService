...
let FollowPersonFeedback = require('./FollowPersonFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FollowPersonActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FollowPersonFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FollowPersonFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FollowPersonActionFeedback(null);
    ...
    data.feedback = FollowPersonFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FollowPersonFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowPersonActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FollowPersonFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FollowPersonFeedback()
    }
...
module.exports = FollowPersonActionFeedback;
