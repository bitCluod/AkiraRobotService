...
class FollowCorridorFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FollowCorridorFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new FollowCorridorFeedback(null);
...
module.exports = FollowCorridorFeedback;
