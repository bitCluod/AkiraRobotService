...
let TurnGoal = require('./TurnGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class TurnActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TurnGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TurnGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TurnActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TurnGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TurnGoal()
    }
