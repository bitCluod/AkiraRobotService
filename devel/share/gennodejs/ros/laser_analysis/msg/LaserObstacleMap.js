...
class LaserObstacleMap {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.var, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LaserObstacleMap(null);
    ...
    data.var = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LaserObstacleMap(null);
...
module.exports = LaserObstacleMap;
