...
set(MSG_I_FLAGS "-Ilaser_analysis:/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacleMap.msg" NAME_WE)
add_custom_target(_laser_analysis_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "laser_analysis" "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacleMap.msg" ""
)

get_filename_component(_filename "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacle.msg" NAME_WE)
add_custom_target(_laser_analysis_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "laser_analysis" "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacle.msg" ""
)
...
### Generating Messages
_generate_msg_eus(laser_analysis
  "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacleMap.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/laser_analysis
)
_generate_msg_eus(laser_analysis
  "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacle.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_eus(laser_analysis
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/laser_analysis
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(laser_analysis_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(laser_analysis_generate_messages laser_analysis_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacleMap.msg" NAME_WE)
add_dependencies(laser_analysis_generate_messages_eus _laser_analysis_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacle.msg" NAME_WE)
add_dependencies(laser_analysis_generate_messages_eus _laser_analysis_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(laser_analysis_geneus)
add_dependencies(laser_analysis_geneus laser_analysis_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS laser_analysis_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(laser_analysis
  "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacleMap.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/laser_analysis
)
_generate_msg_nodejs(laser_analysis
  "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacle.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_nodejs(laser_analysis
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/laser_analysis
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(laser_analysis_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(laser_analysis_generate_messages laser_analysis_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacleMap.msg" NAME_WE)
add_dependencies(laser_analysis_generate_messages_nodejs _laser_analysis_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/salvathor/Documentos/Akira_1.2.2/src/laser_analysis/msg/LaserObstacle.msg" NAME_WE)
add_dependencies(laser_analysis_generate_messages_nodejs _laser_analysis_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(laser_analysis_gennodejs)
add_dependencies(laser_analysis_gennodejs laser_analysis_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS laser_analysis_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/laser_analysis)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/laser_analysis
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(laser_analysis_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/laser_analysis)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/laser_analysis
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(laser_analysis_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser_analysis)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser_analysis\")")
  # install generated code
  install(
