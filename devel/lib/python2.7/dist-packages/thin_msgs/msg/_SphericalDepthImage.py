...
"""autogenerated by genpy from thin_msgs/SphericalDepthImage.msg. Do not edit."""
import codecs
import sys
...
class SphericalDepthImage(genpy.Message):
  _md5sum = "28b67eb85702f0ff03ff03fbb39b252f"
  _type = "thin_msgs/SphericalDepthImage"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Single spherical depth image from a 3D laser range-finder
#
...
"""
  __slots__ = ['header','horizontal_fov','vertical_fov','image']
  _slot_types = ['std_msgs/Header','float32','float32','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,horizontal_fov,vertical_fov,image
    ...
    """
    if args or kwds:
      super(SphericalDepthImage, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2f3I().pack(_x.horizontal_fov, _x.vertical_fov, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.horizontal_fov, _x.vertical_fov, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
